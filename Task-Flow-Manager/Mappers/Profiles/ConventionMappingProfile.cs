...
namespace Task_Flow_Manager.Mappers.Profiles;
...
/// <list type="bullet">
///   <item>
///     <description><c>Task_Flow_Manager.Models</c> – Domain model classes</description>
///   </item>
///   <item>
///     <description><c>Task_Flow_Manager.Dto.Request</c> – DTOs used for client request payloads</description>
///   </item>
///   <item>
///     <description><c>Task_Flow_Manager.Dto.Response</c> – DTOs used for API response payloads</description>
///   </item>
/// </list>
/// <para>
...
public class ConventionMappingProfile : Profile
{
    ...
    {
        const string modelNamespace = "Task_Flow_Manager.Models";
        const string requestNamespace = "Task_Flow_Manager.Dto.Request";
        const string responseNamespace = "Task_Flow_Manager.Dto.Response";
